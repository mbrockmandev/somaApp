...
//struct Profiles: Decodable, Hashable, Identifiable {
...
//  init(from decoder: Decoder) throws {
//    let container = try decoder.container(keyedBy: CodingKeys.self)
//    self.all = try container.decode([Profile].self, forKey: .profiles)
//  }
//}
...
//  }
//  
//  static let mock = Profile(id: "01", name: "Matt Strack", image: "matt_thumb", belt: "Black Belt", locations: ["Dayton, OH"])
//}
